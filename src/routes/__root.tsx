  ...
  head: () => ({
    meta: [
      ...
      { title: "Academy Hub" },
      {
        name: "description",
        content:
          "Premium Academy Student & Fee Management System for tracking student records, courses, payments, and fees.",
      },
      { property: "og:title", content: "Academy Hub" },
      {
    ...
    links: [
      ...
      { rel: "icon", href: "/academy-hub.svg", type: "image/svg+xml" },
    ],
  }),
