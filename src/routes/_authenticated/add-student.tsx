            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={dateJoined}
                  onClick={(e) => {
                    try { (e.currentTarget as HTMLInputElement).showPicker?.(); } catch { /* fallback */ }
                  }}
                  onFocus={(e) => {
                    try { (e.currentTarget as HTMLInputElement).showPicker?.(); } catch { /* fallback */ }
                  }}
            ...
            <div className="mt-4 space-y-4">
              <div className="grid gap-4 sm:grid-cols-2 sm:items-start">
                <div>
                  <div className="flex h-5 items-center justify-between">
                    <label htmlFor="input-total-fees" className="text-xs font-medium text-foreground">
                ...
                <div>
                  <div className="flex h-5 items-center justify-between">
                    <label htmlFor="input-amount-paid" className="text-xs font-medium text-foreground">
              ...
              <div className="grid grid-cols-2 gap-3 rounded-lg border border-border bg-muted/30 p-3.5 text-xs">
                <div>
                  ...
                  <p className="mt-1 font-mono text-sm font-bold text-foreground">{formatCurrency(remaining)}</p>
                </div>
                <div>
